...
namespace EPSN.Areas.Admin.Controllers
{
    ...
    public class TrainersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,E_mail,Description,Creation_Date")] Trainer trainer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,E_mail,Description,Creation_Date")] Trainer trainer)
        {
            if (ModelState.IsValid)
            {
